...
import xyz.blapplappl.ir.ui.login.GuiAltLogin;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
       ...
       buttonList.add(new GuiButton(500, this.width / 2 - 100, this.height / 4 + 48 + 24 * 2, ChatFormatting.LIGHT_PURPLE + "Login"));
